<%@ Page Language="C#" MasterPageFile="~/AllPage2.master" AutoEventWireup="true" CodeFile="PaperSearchNew.aspx.cs" Inherits="PaperSearchNew" Title="Untitled Page" %>
...
<form id="fsfsdfd" runat="server">
    ...
    <div class="feature">
        <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" Width="100%" OnPageIndexChanging="GridView1_PageIndexChanging"
            ...
            <Columns>
                <asp:BoundField DataField="_ISSN" HeaderText="ISSN" />
                <asp:HyperLinkField DataTextField="_刊名" HeaderText="刊名" DataNavigateUrlFields="recid"
                    DataNavigateUrlFormatString="journaldetail.aspx?id={0}" />
                <asp:HyperLinkField DataTextField="_主办者" HeaderText="主办单位">
                    <ControlStyle CssClass="handCursor" />
                </asp:HyperLinkField>
                <asp:HyperLinkField DataTextField="_出版者" HeaderText="出版单位">
                    <ItemStyle CssClass="handCursor" />
                </asp:HyperLinkField>
                <asp:HyperLinkField DataTextField="_出版周期" HeaderText="出版周期">
                    <ControlStyle CssClass="handCursor" />
                </asp:HyperLinkField>
                <asp:HyperLinkField DataTextField="_年期数" HeaderText="年期数">
                    <ControlStyle CssClass="handCursor" />
                </asp:HyperLinkField>
            </Columns>
