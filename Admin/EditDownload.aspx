<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditDownload.aspx.cs" Inherits="Admin_EditDownload" %>
...
<div align="center" style="height:100%;">
  ...
  <table width="100%"  style="height:100%;" align="center" cellpadding="0" cellspacing="0">
    <tr background="images/bg.gif">
      <td height="27" align="middle" background="images/bg.gif"><div align="center"><span class="title"><strong><label id="title" >下载记录修改</label></strong></span><br>
      </div></td>
    </tr>
    <tr>
         ...
         <form action="" method="post" enctype="multipart/form-data" runat="server" id="start">
           ...
           <div class="item">
                &nbsp;&nbsp;缩略图<asp:FileUpload Width="444px"  runat="server" ID="headpic" /></div>
                 <div class="item">
                &nbsp; &nbsp; 文件<Upload:InputFile ID="DownloadFile" runat="server" Width="442px" /><asp:RegularExpressionValidator id="RegularExpressionValidator1" 
            ...
            <div class="item" style="padding-left:50px;">
                 &nbsp; &nbsp;  &nbsp; &nbsp;<input id="mysub" type="submit" onclick="uploadmyfile2()" value="修改" />
                 <input id="Submit2" type="reset" value="重置" /><asp:HiddenField ID="downloadidvalue"  runat="server" />
                </div>
            
         </form>
                <div id="waiting" style="z-index:3; left:6%;display:none;width:550px;position: absolute; top:250px;">
                        <img src="Images/progress.gif" />正在更新，请稍后.....<br />
