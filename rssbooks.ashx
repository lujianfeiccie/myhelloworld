<%@ WebHandler Language="C#" Class="rssbooks" %>
...
public class rssbooks : IHttpHandler {
    ...
    private void buildRss(HttpResponse response)
    {
        ...
        xmlTextWriter.WriteElementString("title", "图书馆最近新书");
        xmlTextWriter.WriteElementString("link", fullUrl);
        xmlTextWriter.WriteElementString("description", "最新入库的 200 种图书");
        ...
        SqlDataReader reader = myrss.GetNewBooks();
        while (reader.Read())
        {            
